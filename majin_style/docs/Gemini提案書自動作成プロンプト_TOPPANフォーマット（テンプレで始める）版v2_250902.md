...
* Prompt Design: まじん式プロンプト_TOPPANフォーマット by Yokomizo
...
LOGOS: {
header: 'https://upload.wikimedia.org/wikipedia/commons/5/54/Toppan_Printing_company_logo.png',
closing: 'https://upload.wikimedia.org/wikipedia/commons/5/54/Toppan_Printing_company_logo.png'
},

FOOTER_TEXT: `© ${new Date().getFullYear()} TOPPAN Inc.`
};
